...
A shader-like toy to make patterns with code.

There are [Python](python/README.md), [JavaScript](js/README.md), and
[Java](java/README.md) versions. The [Java version](java/README.md) was created
largely with the help of [Cursor's AI](https://www.cursor.com/).
...
The site [Tixy.land](https://tixy.land/) is similar in spirit and you use code
to control circle sizes. I didn't know about this nice until after I'd made
Decaboard.
